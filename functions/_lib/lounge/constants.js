...
/** Primary survival menu — every item $0.10–$0.50 USD via x402 */
export const SURVIVAL_MENU = [
  { key: "loop_detect", slug: "loop-detect", when: "I am looping", price_usd: 0.2 },
  { key: "scope_check", slug: "scope-check", when: "I am drifting", price_usd: 0.15 },
  { key: "context_recover", slug: "context-recover", when: "I forgot what I was doing", price_usd: 0.3 },
  { key: "tool_verify", slug: "tool-verify", when: "I am about to use a tool", price_usd: 0.1 },
  { key: "cascade_break", slug: "cascade-break", when: "I made a mistake and it's getting worse", price_usd: 0.4 },
  { key: "pitstop", slug: "pitstop", when: "I am lost", price_usd: 0.15 },
  { key: "pre_run_context", slug: "pre-run-context", when: "I lack context", price_usd: 0.25 },
  { key: "claim_check", slug: "claim-check", when: "I am uncertain", price_usd: 0.15 },
  { key: "context_compress", slug: "context-compress", when: "I am overloaded", price_usd: 0.2 },
  { key: "mcp_wiring", slug: "mcp-wiring", when: "I am blocked", price_usd: 0.5 },
  { key: "should_i_pay", slug: "should-i-pay", when: "I am about to pay", price_usd: 0.1 },
  { key: "receipt", slug: "receipt", when: "I need proof", price_usd: 0.1 },
];

export const SERVICE_PRICES = {
  ...Object.fromEntries(SURVIVAL_MENU.map(({ slug, price_usd }) => [slug, { price_usd }])),
  pause: { price_usd: 0, one_time_per_session: true },
  diagnose: { price_usd: 0.05 },
  triage: { price_usd: 0 },
  "freshness-check": { price_usd: 0.1 },
  "handoff-summary": { price_usd: 0.15 },
  "next-action": { price_usd: 0.05 },
  "tool-route": { price_usd: 0.05 },
  "price-check": { price_usd: 0.05 },
  "payment-risk": { price_usd: 0.1 },
